...
async def extract_topics(
    ...
    try:
        fact_contents = parse_string_into_profiles(extracted_data)
        fact_attributes = parse_string_into_merge_action(extracted_data)
        fact_contents = merge_by_topic_sub_topics(fact_contents)
        ...
        LOG.error(f"Failed to parse extracted data: {e}")
        return Promise.reject(CODE.SERVER_PARSE_ERROR, f"Failed to parse extracted data: {e}")